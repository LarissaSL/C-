...
void criarVC(){
	...
	/*Inserindo o Vetor B em C, começa com ic 20, para não sobrepor os valores de A
	Até o tamanho do vetor B*/
	int ic = 20;
	for (int i = 0; i < tb; i++, ic++){
		vetorC[ic] = vetorB[i];
	}
}
